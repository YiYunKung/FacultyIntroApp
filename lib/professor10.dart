...
class IntroPage10 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const contents = <String>['教授', 'wangch@mail.ncyu.edu.tw',
      '05-2717736', 'A16-507', '資訊安全實驗室',
      '網路安全\n密碼技術\n入侵偵測與防禦',
      '曾任 資工系系主任\n曾任 電算中心系統研發組組長\n中華民國資訊安全學會理事\n行政院資通安全稽核服務團隊委員',
      'http://web.ncyu.edu.tw/~wangch/',
      'https://web085004.adm.ncyu.edu.tw/eRes.pub/Res.aspx?thrid=A0506'
    ];
