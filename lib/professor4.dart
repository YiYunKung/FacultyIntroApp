...
class IntroPage4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const contents = <String>['教授', 'dychan@mail.ncyu.edu.tw',
      '05-2717727', 'A16-517', '視訊處理及應⽤實驗室',
      '視訊處理\n資料壓縮與傳輸\n立體視訊處理\n深度學習網路',
      '曾任 圖書館館長\n曾任 圖書館館長\n曾任 理工學院院長\n創辦電機工程學系之籌備主任\n曾任 資工系系主任\n曾任 電機工程學系主任\n台灣學術(TANET)台南市教育網路中心委員會指導教授\n雲嘉南區域科技政策小組委員\n嘉義市市政顧問',
      'http://web.ncyu.edu.tw/~dychan/',
      'https://web085004.adm.ncyu.edu.tw/eRes.pub/Res.aspx?thrid=A0530'
    ];
