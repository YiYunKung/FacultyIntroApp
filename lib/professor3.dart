...
class IntroPage3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const contents = <String>['助理教授', 'hckuo@mail.ncyu.edu.tw',
      '05-2717731', 'A16-614', '⽣物資料探勘實驗室',
      '人工智慧\n生物資訊\n資料探勘',
      '曾任 住宿服務組組長\n曾任 學務處生活輔導組組長\n曾任 研發處校務研究組組長\n曾任 電算中心行政作業組組長\n曾任 電算中心資訊網路組組長',
      'http://web.ncyu.edu.tw/~hckuo/',
      'https://web085004.adm.ncyu.edu.tw/eRes.pub/Res.aspx?thrid=A0399'
    ];
